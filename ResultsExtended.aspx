<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultsExtended.aspx.cs" Inherits="LuckPrize.ResultsExtended" %>
...
<div style="width:800px">
    ...
    <div style="padding:16px; text-align:left; float:left; width:768px; height:790px; background-image:url('img/pattern_01.jpg');">

        <br><h2>Relatório Bingo</h2><br /><br />

        <br /><br />
            <form id="range" action="ResultsExtended.aspx" method="post" runat="server">
                <asp:ToolkitScriptManager id="toolkit1" runat="server">
                    <Services>
                        <asp:ServiceReference Path="~/WebServices/DataServices.asmx" />
                    </Services>
                </asp:ToolkitScriptManager>
                <div style="width:750px; position:relative; left:10px; background-color:#CCDCDC">
                ...
                <div style="width:750px; position:relative; left:10px; background-color:#E0E0FF">
