<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Extract.aspx.cs" Inherits="LuckPrize.Extract" %>
...
<div style="width:800px">
    ...
    <div style="padding:16px; text-align:left; float:left; width:768px; height:790px; background-image:url('img/pattern_01.jpg');">
        ...
        <br><h2>Meu Extrato</h2><br /><br />

        <br /><br />
            <form id="range" action="Extract.aspx" method="post" runat="server">
