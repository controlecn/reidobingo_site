<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buys.aspx.cs" Inherits="LuckPrize.Buys" %>
...
<div style="width:800px">
    ...
    <div style="padding:16px; text-align:left; float:left; width:768px; height:780px; background-image:url('img/pattern_01.jpg');">
        ...
        <br><h2>Compras de Créditos</h2><br /><br />

            <form id="range" action="Buys.aspx" method="post" runat="server">
