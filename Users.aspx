<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="LuckPrize.Users" %>
...
<div style="width:800px">
    ...
    <div style="padding:16px; text-align:left; float:left; width:768px; height:1200px; background-image:url('img/pattern_01.jpg');">
        ...
        <br><h2>Usuários</h2><br /><br />

            <form id="range" action="Users.aspx" method="post" runat="server">
