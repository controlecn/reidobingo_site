<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogChat.aspx.cs" Inherits="LuckPrize.LogChat" %>
...
<div style="width:800px">
    ...
    <div style="padding:16px; text-align:left; float:left; width:768px; height:1200px; background-image:url('img/pattern_01.jpg');">

        <br><h2>Log do chat</h2><br /><br />


            <form id="range" action="LogChat.aspx" method="post" runat="server">
